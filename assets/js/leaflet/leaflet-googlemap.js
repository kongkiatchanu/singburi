L.TileLayer.ThaiProvider = L.TileLayer.extend({

    initialize: function(type, options) { // (type, Object)
        var providers = L.TileLayer.ThaiProvider.providers;
...
L.TileLayer.ThaiProvider.providers = {
    TianDiTu: {
        Normal: {
    ...
    Google: {
        Normal: {
            Map: "https://www.google.co.th/maps/vt?lyrs=m&hl=th&x={x}&y={y}&z={z}"
            // Map: "https://www.google.com/vt/lyrs=s,h@189&x={x}&y={y}&z={z}"
        },
        Satellite: {
            Map: "https://www.google.co.th/maps/vt?lyrs=s,h&hl=th&x={x}&y={y}&z={z}"
            // Map: "https://www.google.com/vt/lyrs=m@189&x={x}&y={y}&z={z}"
        },
        Subdomains: []
    },
...
L.tileLayer.ThaiProvider = function(type, options) {
    return new L.TileLayer.ThaiProvider(type, options);
};